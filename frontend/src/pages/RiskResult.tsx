...
const RISK_CONFIG = {
  high: {
    ...
    bar: "bg-red-500",
    icon: TrendingUp,
    msg: "Your readings indicate elevated cardiovascular risk. Please review your recommendations carefully and consider seeking medical advice.",
  },
  medium: {
    ...
    bar: "bg-amber-400",
    icon: Minus,
    msg: "Your readings show moderate risk. Lifestyle improvements like diet, exercise, and regular check-ups can help.",
  },
  low: {
    ...
    bar: "bg-emerald-500",
    icon: TrendingDown,
    msg: "Great news! Your readings are in a healthy range. Keep up your good habits and continue monitoring regularly.",
  },
};
...
export function RiskResult() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 pb-16">
      {/* Hero band */}
      <div
        className={`bg-gradient-to-r ${cfg.bg} px-6 py-14 text-white text-center relative overflow-hidden`}
      >
      ...
      <div className="max-w-xl mx-auto px-4 -mt-6 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-lg p-6">
          <div className="flex items-center justify-between mb-3">
            ...
            <span
              className={`px-3 py-1 rounded-full text-sm font-bold border ${cfg.badge}`}
            >
              {level}
            </span>
          </div>
          ...
          <div className="h-4 bg-slate-100 rounded-full overflow-hidden">
            <div
              className={`h-full ${cfg.bar} rounded-full transition-all duration-1000 ${getWidthClass(score)}`}
            />
          </div>
          ...
          <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-red-600 text-xs mt-0.5">
                A risk alert has been sent to your care team for review.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="space-y-3">
          ...
          >
            <span className="flex items-center gap-2">
              <Home className="h-4 w-4" /> My Health Dashboard
            </span>
